...
@author: gdk
"""
from domain.actions import ACTION_DOWN, ACTION_NOP, ACTION_LEFT, ACTION_RIGHT, ACTION_UP, ACTION_JUMP, ACTION_INTERACT
from domain.cell_types import OPEN_SPACE, LADDER, WALL
from domain.objects import handle, bolt
from domain.option import miner_option
from domain.scale import xscale, yscale


class go_left_option(miner_option):
    
    def __init__(self, md, drawer = None):
        miner_option.__init__(self, md, drawer)        
...
class go_right_option(miner_option):
...
class up_ladder_option(miner_option):
...
class down_ladder_option(miner_option):
...
class down_left_option(miner_option):
...
class jump_left_option(miner_option):
...
class jump_right_option(miner_option):
...
class down_right_option(miner_option):
...
class interact_option(miner_option):
    def __init__(self, md, drawer = None):
        miner_option.__init__(self, md, drawer)
