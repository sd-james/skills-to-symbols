...
import pygame
import numpy as np
from s2s.env.treasure_game._treasure_game_impl import _treasure_game_drawer
from s2s.env.treasure_game._treasure_game_impl._actions import ACTION_UP, ACTION_DOWN, ACTION_LEFT, ACTION_RIGHT, \
    ACTION_JUMP, ACTION_INTERACT
from s2s.env.treasure_game._treasure_game_impl._cell_types import WALL, LADDER, OPEN_SPACE, DOOR
from s2s.env.treasure_game._treasure_game_impl._move_options import go_left_option, go_right_option, up_ladder_option, \
    down_ladder_option, interact_option, down_left_option, down_right_option, jump_left_option, jump_right_option
from s2s.env.treasure_game._treasure_game_impl._objects import door, handle, bolt, key, goldcoin
from s2s.env.treasure_game._treasure_game_impl._scale import xscale, yscale
